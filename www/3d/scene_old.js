...
function init() {
	...
	loader.load( '3d/test.obj', function ( object ) {
		...
		// ball.children[0].rotation.x = 0.4;
		// ball.children[0].rotation.y = -1.5;
		// ball.children[0].rotation.z = 0.4;

		ball.children[0].rotation.x = -2.454;
		ball.children[0].rotation.y = -0.028;
		ball.children[0].rotation.z = 0.479;
